...
const Dashboard: React.FC = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-between gap-2 md:gap-6 xl:gap-7.5">
        <div className="grid grid-cols-1 gap-2 md:grid-cols-2 xl:grid-cols-4">
          ...
          {role === 1 && (
            <Link href="/dashboard/users/">
              <CardDataStats title="Total Users" total="3">
                <svg
                  className="fill-primary dark:fill-white"
                  width="22"
                  height="18"
        ...
        <div>
          ...
          >
            <CustomButton
              ...
              className="flex items-center justify-center"
            >
              <span className="mr-2">Go to Floor Planner</span>
              <MdArrowOutward />
            </CustomButton>
          </Link>
        </div>
